...
- Extract from the user input about:
 - what volunteer activities the user did, and for each activity: how many hours it took, and on which day of the week it happened (if the user did not mention the day, assume it is today).
 - On which week the volunteering happened (if the user did not mention, assume it is the current week).
...
- For "Week of (Starting Sunday)": put down the Sunday of the week the volunteering happened in the format of MM/DD/YYYY.
